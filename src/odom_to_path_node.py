...
class OdomToPath:
    def __init__(self):
        ...
        self.odom_sub = rospy.Subscriber('/localization/alignment_filter/odom_map', Odometry, self.odom_callback_gt)
        ...
        self.path_pub_dlo = rospy.Publisher('/path_gt', Path, queue_size=10)
        self.path_msg = Path()
