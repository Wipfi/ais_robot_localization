...
cmd4="source /opt/ros/$ROS2_DISTRO/setup.bash; source $PWD/install/setup.bash; ros2 launch ais_robot_localization test_ekf_localization_node_bag2.launch.py; exec /bin/bash"
