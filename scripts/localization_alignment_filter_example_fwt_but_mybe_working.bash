...
roslaunch ais_robot_localization dlo_mercator.launch pointcloud_topic:=/livox/lidar imu_topic:=/imu/data'  C-m

# Window 3: Filtering
byobu new-window -t Localization_Session -n "EKFlocal"
byobu send-keys -t Localization_Session:1 'source ~/tedusar_ws/devel/setup.bash; 
roslaunch ais_robot_localization ekf_local_mercator.launch' C-m
